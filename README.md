...
- **🎯 Metas Financeiras (Goals):** Defina objetivos (ex: "Viagem pro Rio"), estipule metas de valor e prazos limites com barras dinâmicas. Conta com integração bidirecional e consistência automática em nível de banco de dados: transações geradas por metas mantêm o saldo delas sincronizado dinamicamente em qualquer criação, edição ou deleção, seja via tela de metas ou diretamente no histórico de transações.
