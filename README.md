...
- **🎯 Metas Financeiras (Goals):** Defina objetivos (ex: "Viagem pro Rio"), estipule metas de valor e prazos limites, acompanhando o progresso com barras dinâmicas coloridas. Oferece a opção integrada e seletiva de gerar automaticamente lançamentos no fluxo de caixa (Aporte como despesa e Resgate como receita) com auto-categorização por tag.
