...
- **🎯 Metas Financeiras (Goals):** Defina objetivos (ex: "Viagem pro Rio"), estipule metas de valor e prazos limites com barras dinâmicas. Conta com integração bidirecional e consistência automática em nível de banco de dados: transações vinculadas a metas mantêm o saldo delas sincronizado dinamicamente. Aportes oficiais (saídas com descrição "Aporte") ou receitas manuais somam ao progresso da meta, enquanto resgates oficiais (entradas com descrição "Resgate") ou despesas/saídas manuais subtraem do progresso da meta de forma automática (na criação, edição ou exclusão). Adicionalmente, regras recorrentes (como compras parceladas ou assinaturas) podem ser vinculadas a metas, propagando o vínculo para todas as suas parcelas geradas e mantendo a consistência do progresso da meta automaticamente.
