...
urlpatterns = [
    ...
    path('cards/<int:pk>/delete/with-transactions/', views.card_delete_with_transactions, name='card_delete_with_transactions'),
    path('cards/<int:pk>/delete/modal/', views.card_delete_modal, name='card_delete_modal'),
